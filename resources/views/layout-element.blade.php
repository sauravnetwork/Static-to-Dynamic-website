...
<div id="loading-area"></div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="extra-nav">
                        <div class="extra-cell">
							...
							<a href="javascript:void(0);" class="site-button">Apply Now</a>
						</div>
                    </div>
                    <!-- Quik search -->
    ...
    @yield('shortcode-accordians')
    @yield('shortcode-alert-box')
    @yield('shortcode-all-widgets')
    @yield('shortcode-animation-effects')
    @yield('shortcode-buttons')
    @yield('shortcode-icon-box-styles')
    @yield('shortcode-pricing-table')
    @yield('shortcode-toggles')
    @yield('shortcode-team')
    @yield('shortcode-carousel-sliders')
    @yield('shortcode-image-box-content')
    @yield('shortcode-tabs')
    @yield('shortcode-counters')
    @yield('shortcode-shop-widgets')
    @yield('shortcode-filters')
    @yield('shortcode-dividers')
    @yield('shortcode-images-effects')
    @yield('shortcode-testimonials')
    @yield('shortcode-pagination')
    @yield('shortcode-icon-box')
    @yield('shortcode-list-group')
    @yield('shortcode-title-separators')
                        ...
                        <div class="widget border-0 recent-posts-entry">
							...
							<div class="widget-post-bx">
								<div class="widget-post clearfix">
									...
									<div class="dlab-post-info">
										<div class="dlab-post-header">
											<h6 class="post-title"><a href="blog-single">Helping you and your house become better.</a></h6>
										</div>
								...
								<div class="widget-post clearfix">
									...
									<div class="dlab-post-info">
										<div class="dlab-post-header">
											<h6 class="post-title"><a href="blog-single">Creating quality urban lifestyles.</a></h6>
										</div>
										<div class="dlab-post-meta">
											<ul>
												<li class="post-date"> <i class="la la-clock"></i> <strong>01 June</strong> <span> 2020</span> </li>
