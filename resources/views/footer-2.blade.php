        ...
        <div class="dlab-bnr-inr overlay-black-middle bg-pt" style="background-image:url(images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Footer 2</h1>
					<!-- Breadcrumb row -->
					...
					<div class="footer-box">
						<div class="row align-items-center">
							...
							<div class="col-lg-9 col-md-8">
								<h2 class="title">Check Footer Style 02</h2>
    ...
    &lt;div class="container-fluid"&gt;
      &lt;div class="row"&gt;
        &lt;div class="col-md-4 text-center text-md-left footer-logo"&gt;
          &lt;img src="images/logo-white.png" alt="" width="140"/&gt;
        &lt;/div&gt;
        ...
        &lt;div class="col-md-4  text-center text-md-right"&gt;
          &lt;p class="max-w600 m-auto m-t10"&gt;Copyright © 2020 DexignZone&lt;/p&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/div&gt;
  &lt;/div&gt;
    ...
    <footer class="site-footer footer-full ">
        <div class="p-tb60 bg-primary">
            <div class="container-fluid">
                <div class="row">
					<div class="col-md-4 text-center text-md-left footer-logo">
						<img src="images/logo-light.png" alt="" width="140"/>
					</div>
					<div class="col-md-4 text-center">
						<ul class="list-inline m-a0">
							<li><a class="site-button white outline circle"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-4  text-center text-md-right">
						<p class="max-w600 m-auto m-t10 text-white">Copyright © 2020 DexignZone</p>
					</div>
				</div>
            </div>
        </div>
