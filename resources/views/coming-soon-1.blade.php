		...
		<div id="rev_slider_152_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
			<ul><!-- SLIDE  -->
				<li data-index="rs-414" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<img src="images/background/cs.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="20000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
					<!-- LAYER NR. 1 -->
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 5; white-space: nowrap; font-size: 30px; line-height: 30px; font-weight: 500; color: rgba(255,255, 255, 1.00);font-family:Poppins;">Industry
					</div>
					<!-- LAYER NR. 2 -->
					<div class="tp-caption   tp-resizeme" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 8; min-width: 300px; max-width: 300px; white-space: nowrap; font-size: 200px; line-height: 200px; font-weight: 600; color:#2ec4b6;font-family:Poppins;letter-spacing:-5px;" 
						id="t_days">00 
					</div>
					<!-- LAYER NR. 5 -->
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 9; min-width: 300px; max-width: 300px; white-space: nowrap; font-size: 200px; line-height: 200px; font-weight: 600; color:#2ec4b6;font-family:Poppins;letter-spacing:-5px;" 
						id="t_hourss">00 
					</div>
					<!-- LAYER NR. 6 -->
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 10; min-width: 300px; max-width: 300px; white-space: nowrap; font-size: 200px; line-height: 200px; font-weight: 600; color:#2ec4b6;font-family:Poppins;letter-spacing:-5px;" 
						id="t_minutes">00 
					</div>
					<!-- LAYER NR. 7 -->
					<div class="tp-caption   tp-resizeme" 
						...
						style="z-index: 11; min-width: 300px; max-width: 300px; white-space: nowrap; font-size: 200px; line-height: 200px; font-weight: 600; color:#2ec4b6;font-family:Poppins;letter-spacing:-5px;" 
						id="t_seconds">00 
					</div>
					<!-- LAYER NR. 8 -->
					<div class="tp-caption   tp-resizeme" 
					...
					<!-- LAYER NR. 12 -->
					<a class="tp-caption tp-resizeme" target="_blank" href="javascript:void(0);" id="slide-414-layer-16" 
						data-x="['left','left','left','left']" data-hoffset="['100','50','50','30']" 
					...
					<!-- LAYER NR. 13 -->
					<a class="tp-caption tp-resizeme" target="_blank" href="javascript:void(0);" id="slide-414-layer-17" 
					...
					<!-- LAYER NR. 14 -->
					<a class="tp-caption tp-resizeme" target="_blank" href="javascript:void(0);" id="slide-414-layer-18" 
