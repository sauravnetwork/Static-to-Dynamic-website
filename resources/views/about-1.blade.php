    ...
    <div class="page-content bg-white">
        ...
        <div class="content-block">
					...
					<div class="row about-one align-items-center">
						...
						<div class="col-lg-6 m-b30">
							<div class="content-bx">
								...
								<p class="m-b20">Lorem Ipsum is simply dummy text of the printing and typesetting industry has been the industry's standard dummy text ever since the been when an unknown printer There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>											
			...
			<div class="section-full text-white bg-img-fix content-inner overlay-black-dark counter-staus-box" style="background-image:url(images/background/bg4.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-lg-3 m-b30 col-sm-6 col-6 wow fadeInUp counter-style-5" data-wow-duration="2s" data-wow-delay="0.2s">
						...
						<div class="col-md-3 col-lg-3 m-b30 col-sm-6 col-6 wow fadeInUp counter-style-5" data-wow-duration="2s" data-wow-delay="0.4s">
							<div class="icon-bx-wraper center">
								<div class="icon-content">
						...
						<div class="col-md-3 col-lg-3 m-b30 col-sm-6 col-6 wow fadeInUp counter-style-5" data-wow-duration="2s" data-wow-delay="0.6s">
							<div class="icon-bx-wraper center">
								<div class="icon-content">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="dlab-box m-b30 dlab-team1">
								...
								<div class="dlab-info">
									<h4 class="dlab-title"><a href="teachers-profile">Nashid Martines</a></h4>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="dlab-box m-b30 dlab-team1">
								...
								<div class="dlab-info">
									<h4 class="dlab-title"><a href="teachers-profile">Konne Backfield</a></h4>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="dlab-box m-b30 dlab-team1">
								...
								<div class="dlab-info">
									<h4 class="dlab-title"><a href="teachers-profile">Hackson Willingham</a></h4>
