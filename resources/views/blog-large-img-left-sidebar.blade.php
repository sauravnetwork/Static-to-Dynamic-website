@extends('layout-blog')
@section('blog-large-img-left-sidebar')
    <!-- Content -->
        ...
        <div class="dlab-bnr-inr overlay-black-middle bg-pt" style="background-image:url(images/banner/bnr1.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Blog large image left sidebar</h1>
					<!-- Breadcrumb row -->
                    ...
                    <div class="col-xl-9 col-lg-8 col-md-7">
                        <div class="blog-post blog-lg blog-rounded shadow bg-white">
							<div class="dlab-post-media dlab-img-effect zoom-slow"> 
								<a href="blog-single.html"><img src="images/blog/default/thum1.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a25">
								...
								<div class="dlab-post-title ">
									<h4 class="post-title"><a href="blog-single.html">Why is Early Education Essential?</a></h4>
								</div>
						...
						<div class="blog-post blog-lg blog-rounded shadow bg-white">
							<div class="dlab-post-media dlab-img-effect zoom-slow"> 
								<a href="blog-single.html"><img src="images/blog/default/thum2.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a25">
								<div class="dlab-post-meta">
									<ul>
						...
						<div class="blog-post blog-lg blog-rounded shadow bg-white">
							<div class="dlab-post-media dlab-img-effect zoom-slow"> 
								<a href="blog-single.html"><img src="images/blog/default/thum3.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a25">
								<div class="dlab-post-meta">
									<ul>
								...
								<div class="dlab-post-title ">
									<h4 class="post-title"><a href="blog-single.html">Five Things Nobody Told You About</a></h4>
								</div>
								<div class="dlab-post-text">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
								</div>
						...
						<div class="blog-post blog-lg blog-rounded shadow bg-white">
							<div class="dlab-post-media dlab-img-effect zoom-slow"> 
								<a href="blog-single.html"><img src="images/blog/default/thum4.jpg" alt=""></a> 
							</div>
							<div class="dlab-info p-a25">
								<div class="dlab-post-meta">
									<ul>
								...
								<div class="dlab-post-title ">
									<h4 class="post-title"><a href="blog-single.html">Here's What People Are Saying About</a></h4>
								</div>
								<div class="dlab-post-text">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
								</div>
						...
						<div class="blog-post blog-lg blog-rounded shadow bg-white">
							...
							<div class="dlab-info p-a25">
								...
								<div class="dlab-post-title ">
									<h4 class="post-title"><a href="blog-single.html">How Education Can Ease Your Pain </a></h4>
								</div>
								<div class="dlab-post-text">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
								</div>
						...
						<div class="blog-post blog-lg blog-rounded shadow bg-white">
							...
							<div class="dlab-info p-a25">
								...
								<div class="dlab-post-title ">
									<h4 class="post-title"><a href="blog-single.html">Why You Should Not Go To Education</a></h4>
								</div>
								<div class="dlab-post-text">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
								</div>
