...
@section('header-style-dark-3')
    <!-- Content -->
    <div class="page-content">
        <!-- inner page banner -->
        <div class="dlab-bnr-inr overlay-black-dark banner-content " style="background-image:url(images/banner/bnr3.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Header Style Topbar Primary</h1>
					<!-- Breadcrumb row -->
					...
					<div class="header-box">
						<div class="row align-items-center">
							...
							<div class="col-lg-9 col-md-8">
								<h2 class="title">Check Header Style 03</h2>
...
&lt;!-- header --&gt;
&lt;header class="site-header mo-left header dark"&gt;
	&lt;div class="top-bar"&gt;
		&lt;div class="container"&gt;
