...
<head>
	...
	<link rel="stylesheet" type="text/css" href="plugins/flaticon/education/flaticon.css">
...
<div id="loading-area"></div>
			...
			<div class="container">
				<div class="row d-flex justify-content-between align-items-center">
					<div class="dlab-topbar-left">
						<ul>
							<li><i class="la la-phone-volume text-white"></i> +00 888 6668811</li>
							<li><i class="las la-map-marker text-white"></i> 1073 W Stephen Ave, Clawson</li>
						</ul>
					</div>
					<div class="dlab-topbar-right">
						<ul>
							<li><i class="la la-clock text-white"></i>  Mon - Sat 8.00 - 18.00</li>
							<li><i class="las la-envelope-open text-white"></i> info@example.com</li>
						</ul>				
					</div>
				</div>
			</div>
						...
						<ul>	
							...
							<li data-index="rs-100" data-transition="slideoververtical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
								...
								<div class="tp-caption " 
									...
									data-x="['center','center','center','center']" data-hoffset="['-90','50','0','0']" 
									data-y="['middle','middle','middle','middle']" data-voffset="['-70','-55','-50','-70']" 
									data-fontsize="['65','50','40','30']"
									data-lineheight="['75','60','50','40']"
									data-width="['1000','1000','768','360']"
									data-height="none"
									...
									data-paddingbottom="[0,0,0,0]"
									data-paddingleft="[0,0,0,0]"
									style="z-index: 6; min-width: 800px; max-width: 800px; font-weight: 500; white-space: normal; color: #fff;font-family: 'Merriweather', serif">           
									Children Academy <br/>First ReseaArchers
								</div>
								<!-- LAYER NR. 3 -->
								<div class="tp-caption" 
									id="slide-100-layer-3" 
									data-x="['center','center','center','center']" data-hoffset="['-265','-170','0','0']" 
									data-y="['middle','middle','middle','middle']" data-voffset="['60','55','50','30']" 
									...
									data-paddingbottom="[0,0,0,0]"
									data-paddingleft="[0,0,0,0]"
									style="z-index: 7; min-width: 640px; max-width: 640px; font-weight: 700; font-size: 18px; line-height: 30px; font-weight: 400; color: #fff; font-family: 'Poppins',sans-serif;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the when an printer took a galley.
								</div>
								<!-- LAYER NR. 5 -->
								<a class="tp-caption rev-btn tc-btnshadow tp-rs-menulink bg-primary" 
									href="about-1" target="_blank"			 
									id="slide-100-layer-4" 
									data-x="['center','center','center','center']" data-hoffset="['-515','-375','-90','-75']" 
									data-y="['middle','middle','middle','middle']" data-voffset="['150','140','130','120']" 
    ...
    <div class="page-content bg-white">
        ...
        <div class="content-block">
            ...
            <div class="section-full bg-white content-inner-1 text-center">
                <div class="container">
					<div class="section-head kinder-head">
						<h2 class="head-title text-primary">Welcome to  Kids Center</h2>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.2s"  data-wow-duration="2s">
							<div class="icon-bx-wraper sr-iconbox m-b20">
								<div class="icon-lg m-b20">
									<a href="javascript:void(0);" class="icon-cell"><img src="images/icon/kindergarten/icon1.jpg" alt=""/></a>
								</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.4s"  data-wow-duration="2s">
							<div class="icon-bx-wraper sr-iconbox m-b20">
								<div class="icon-lg m-b20">
									<a href="javascript:void(0);" class="icon-cell"><img src="images/icon/kindergarten/icon2.jpg" alt=""/></a>
								</div>
								<div class="icon-content">
									<h6 class="dlab-tilte">To Feel Fne and to<br/>Understand Emotions</h6>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.6s"  data-wow-duration="2s">
							<div class="icon-bx-wraper sr-iconbox m-b20">
								<div class="icon-lg m-b20">
									<a href="javascript:void(0);" class="icon-cell"><img src="images/icon/kindergarten/icon3.jpg" alt=""/></a>
								</div>
								<div class="icon-content">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 wow fadeIn" data-wow-delay="0.8s"  data-wow-duration="2s">
							<div class="icon-bx-wraper sr-iconbox">
								<div class="icon-lg m-b20">
									<a href="javascript:void(0);" class="icon-cell"><img src="images/icon/kindergarten/icon4.jpg" alt=""/></a>
								</div>
								<div class="icon-content">
			...
			<!-- About Us End -->
			<div class="section-full bg-white content-inner kinder-about" style="background-image:url(images/background/kindergarten/line.png); background-size:contain;background-repeat: no-repeat;background-position: center;">
                <div class="container">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12 wow fadeIn" data-wow-delay="0.2s"  data-wow-duration="2s">
							<div class="section-head kinder-head">
								<h2 class="head-title text-primary">Do you dream that<br/>your child will become<br/>intelligent?</h2>
								...
								<a href="faqs" class="site-button button-md btnhover12 radius-xl">Learn more</a>
							</div>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<div class="icon-bx-wraper left">
								<div class="icon-lg m-b20"> <span class="icon-cell text-blue"><i class="flaticon-rattle"></i></span> </div>
								<div class="icon-content">
									<h2 class="dlab-tilte">Infants</h2>
									<p>Lectus placerat a ultricies a,interdum donec eget metus auguen u Fusce mollis imperdiet interdum donec eget metus.</p>
								</div>
							</div>
							<div class="icon-bx-wraper left">
								<div class="icon-lg m-b20"> <span class="icon-cell text-green"><i class="flaticon-bricks"></i></span> </div>
								<div class="icon-content">
									<h2 class="dlab-tilte">I myself</h2>
									<p>Lectus placerat a ultricies a,interdum donec eget metus auguen u Fusce mollis imperdiet interdum donec eget metus.</p>
								</div>
							</div>
							<div class="icon-bx-wraper left">
			...
			<div class="section-full bg-white content-inner-2 kinder-about-content bg-img-fix" style="background-image:url(images/background/kindergarten/bg1.jpg);">
			...
			<div class="section-full bg-white content-inner-1">
                <div class="container">
					...
					<div class="gallery-carousel owl-carousel owl-theme dots-none sprite-nav" id="lightgallery">
						<div class="item">
							 <div class="dlab-box kinder-frame">
								<div class="dlab-thum dlab-img-overlay1"> 
									<a href="javascript:void(0);">
										<img src="images/gallery/kindergarten/pic4.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<span data-exthumbimage="images/gallery/kindergarten/pic4.jpg" data-src="images/gallery/kindergarten/pic4.jpg" class="check-km" title="Title Come Here">
						...
						<div class="item">
							 <div class="dlab-box kinder-frame">
								<div class="dlab-thum dlab-img-overlay1"> 
									<a href="javascript:void(0);">
										<img src="images/gallery/kindergarten/pic5.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<span data-exthumbimage="images/gallery/kindergarten/pic5.jpg" data-src="images/gallery/kindergarten/pic5.jpg" class="check-km" title="Title Come Here">
												<i class="fa fa-search icon-bx-xs"></i>
											</span>
										</div>
									</div>
						...
						<div class="item">
							 <div class="dlab-box kinder-frame">
								<div class="dlab-thum dlab-img-overlay1"> 
									<a href="javascript:void(0);">
										<img src="images/gallery/kindergarten/pic6.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<span data-exthumbimage="images/gallery/kindergarten/pic6.jpg" data-src="images/gallery/kindergarten/pic6.jpg" class="check-km" title="Title Come Here">
												<i class="fa fa-search icon-bx-xs"></i>
											</span>
										</div>
									</div>
						...
						<div class="item">
							 <div class="dlab-box kinder-frame">
								<div class="dlab-thum dlab-img-overlay1"> 
									<a href="javascript:void(0);">
										<img src="images/gallery/kindergarten/pic1.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<span data-exthumbimage="images/gallery/kindergarten/pic1.jpg" data-src="images/gallery/kindergarten/pic1.jpg" class="check-km" title="Title Come Here">
												<i class="fa fa-search icon-bx-xs"></i>
											</span> 
										</div>
									</div>
						...
						<div class="item">
							 <div class="dlab-box kinder-frame">
								<div class="dlab-thum dlab-img-overlay1"> 
									<a href="javascript:void(0);">
										<img src="images/gallery/kindergarten/pic2.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<span data-exthumbimage="images/gallery/kindergarten/pic2.jpg" data-src="images/gallery/kindergarten/pic2.jpg" class="check-km" title="Title Come Here">
												<i class="fa fa-search icon-bx-xs"></i>
											</span>
										</div>
									</div>
						...
						<div class="item">
							 <div class="dlab-box kinder-frame">
								<div class="dlab-thum dlab-img-overlay1"> 
									<a href="javascript:void(0);">
										<img src="images/gallery/kindergarten/pic3.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<span data-exthumbimage="images/gallery/kindergarten/pic3.jpg" data-src="images/gallery/kindergarten/pic3.jpg" class="check-km" title="Title Come Here">
												<i class="fa fa-search icon-bx-xs"></i>
											</span>
										</div>
									</div>
			...
			<div class="section-full bg-white content-inner-1" style="background-image:url(images/line2.png); background-size:contain;background-repeat: no-repeat;background-position: center;">
                <div class="container">
					<div class="section-head kinder-head text-center">
						<h2 class="head-title text-primary">About the Teachers</h2>
					...
					<div class="kinder-carousel owl-carousel owl-theme dots-none sprite-nav">
						<div class="item">
							 <div class="dlab-box box-frame1 kinder-team">
								<div class="dlab-thum"> 
									<a href="teachers-profile">
										<img src="images/our-team/kindergarten/pic1.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<h5 class="team-title"><a href="teachers-profile">Jone Doe</a></h5>
						...
						<div class="item">
							 <div class="dlab-box box-frame2 kinder-team">
								<div class="dlab-thum"> 
									<a href="teachers-profile">
										<img src="images/our-team/kindergarten/pic2.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<h5 class="team-title"><a href="teachers-profile">Jone Doe</a></h5>
										<span class="team-info">Teachers</span>
						...
						<div class="item">
							 <div class="dlab-box box-frame3 kinder-team">
								<div class="dlab-thum"> 
									<a href="teachers-profile">
										<img src="images/our-team/kindergarten/pic3.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<h5 class="team-title"><a href="teachers-profile">Jone Doe</a></h5>
										<span class="team-info">Teachers</span>
						...
						<div class="item">
							 <div class="dlab-box box-frame4 kinder-team">
								<div class="dlab-thum"> 
									<a href="teachers-profile">
										<img src="images/our-team/kindergarten/pic4.jpg" alt="">
									</a>
									<div class="overlay-bx">
										<h5 class="team-title"><a href="teachers-profile">Jone Doe</a></h5>
										<span class="team-info">Teachers</span>
			...
			<div class="section-full bg-white content-inner-1">
                <div class="container">
					<div class="section-head kinder-head text-center">
						<h2 class="head-title text-primary">Testimonials about center</h2>
						<p>We have an excellent teacher to child ratio at our Kindergarten to ensure that each child receives the attention he or she needs</p>
					</div>
			...
			<div class="section-full bg-white content-inner">
				<div class="container">
					<div class="section-head kinder-head text-center">
						<h2 class="head-title text-primary">From the Blog</h2>
						<p>We have an excellent teacher to child ratio at our Kindergarten to ensure that each child receives the attention he or she needs</p>
					</div>
					<div class="blog-carousel kinder-blog-area owl-carousel owl-theme dots-none sprite-nav owl-btn-center-lr">
						<div class="item">
							<div class="blog-post blog-grid kinder-blog">
                                <div class="dlab-post-media kinder-frame">
									<a href="blog-single"><img src="images/our-services/kindergarten/pic1.jpg" alt=""></a>
								</div>
                                <div class="dlab-info">
                                    <div class="dlab-post-title">
                                        <h4 class="post-title"><a href="blog-single">The Biggest Contribution Of Education Blog To Humanity.</a></h4>
                                    </div>
                                    <div class="dlab-post-text">
                                       <p>Separation Tips You and your child are about to have an amazing and fun...</p>
                                    </div>
									<div class="dlab-post-readmore"> 
										<a href="blog-single" title="READ MORE" rel="bookmark" class="btn-link">Read More</a>
									</div>
                                </div>
                            </div>
						</div>
						<div class="item">
							<div class="blog-post blog-grid kinder-blog ">
                                <div class="dlab-post-media kinder-frame">
									<a href="blog-single"><img src="images/our-services/kindergarten/pic2.jpg" alt=""></a>
								</div>
                                <div class="dlab-info">
                                    <div class="dlab-post-title">
                                        <h4 class="post-title"><a href="blog-single">The Truth About Education Blog Is About To Be Revealed.</a></h4>
                                    </div>
                                    <div class="dlab-post-text">
                                       <p>Separation Tips You and your child are about to have an amazing and fun...</p>
                                    </div>
						...
						<div class="item">
							<div class="blog-post blog-grid kinder-blog ">
                                <div class="dlab-post-media kinder-frame">
									<a href="blog-single"><img src="images/our-services/kindergarten/pic3.jpg" alt=""></a>
								</div>
                                <div class="dlab-info">
                                    <div class="dlab-post-title">
                                        <h4 class="post-title"><a href="blog-single">Five Reasons Why People Like Education Blog.</a></h4>
                                    </div>
                                    <div class="dlab-post-text">
                                       <p>Separation Tips You and your child are about to have an amazing and fun...</p>
                                    </div>
	...
	<!-- Content END-->
	<!-- Footer -->
    <footer class="site-footer kinder-footer text-white">
                            ...
                            <h5 class="footer-title">Recent Posts</h5>
								<div class="widget-post-bx">
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="dlab-post-info">
                                            <div class="dlab-post-header">
												<h6 class="post-title"><a href="blog-single">What It's Like Dating.</a></h6>
                                            </div>
                                    ...
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="dlab-post-info">
                                            <div class="dlab-post-header">
												<h6 class="post-title"><a href="blog-single">The Reasons Why We Love</a></h6>
                                            </div>
                                            <div class="dlab-post-meta">
                                                <ul>
							...
							<div class="subscribe-form m-b20">
								<form class="dzSubscribe" action="script/mailchamp.php" method="post">
									...
									<div>
										...
										<button name="submit" value="Submit" type="submit" class="site-button btnhover12 button-md black radius-xl">Subscribe</button>
									</div>
								</form>
							</div>
                        </div>
        ...
        <div class="footer-bottom bg-primary">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-6 text-left "> <span>Copyright © 2020 DexignZone. All right reserved</span> </div>
