...
@yield('blog-half-img')
@yield('blog-half-img-sidebar')
@yield('blog-half-img-left-sidebar')
@yield('blog-large-img')
@yield('blog-large-img-sidebar')
@yield('blog-large-img-left-sidebar')
@yield('blog-grid-2')
@yield('blog-grid-2-sidebar')
@yield('blog-grid-2-sidebar-left')
@yield('blog-grid-3')
@yield('blog-grid-3-sidebar-left')
@yield('blog-grid-3-sidebar')
@yield('blog-grid-4')
@yield('blog-single')
@yield('blog-single-sidebar')
@yield('blog-single-left-sidebar')
	<!-- Footer -->
   <!-- Newsletter -->
